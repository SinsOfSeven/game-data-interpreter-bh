...
import UniqueMonstersa from "../data/UniqueMonsterMetaData.json" assert {type:"json"}

var UniqueMonsters:UniqueMonster[] = UniqueMonstersa
...
//const PropertiesMap = new Map<number,MonsterConfigSimple>()
